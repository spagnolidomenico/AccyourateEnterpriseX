...
public sealed class MasterDataEmployeeRepository : SqliteRepositoryBase, IEmployeeRepository
{
    public MasterDataEmployeeRepository()
        : this(AccyourateDatabaseContextFactory.CreateMasterDataContext())
    {
    }

    public MasterDataEmployeeRepository(AccyourateDatabaseContext context) : base(context)
    {
    }
