...
public sealed class UniversalCommandBarView : UserControl
{
    ...
    public UniversalCommandBarView(DatabaseService database, CurrentUser user, Action<string, string>? navigate = null)
    {
        _database = database;
        _user = user;
        _navigate = navigate;
