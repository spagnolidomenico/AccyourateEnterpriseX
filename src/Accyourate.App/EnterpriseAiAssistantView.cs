...
public sealed class EnterpriseAiAssistantView : UserControl
{
    ...
    public EnterpriseAiAssistantView(DatabaseService database, CurrentUser user)
    {
        _database = database;
        _user = user;
        ...
        var header = new Border
        {
            ...
            Child = new StackPanel
            {
                ...
                Children =
                {
                    ...
                    new TextBlock { Text = "Assistente operativo integrato nella Workspace", Foreground = UiTokens.Brush(UiTokens.TextSecondary) }
                }
            }
        };
