...
public sealed class ActionEngineView : UserControl
{
    ...
    public ActionEngineView(DatabaseService database, CurrentUser user)
    {
        _database = database;
        _user = user;
    ...
    private Control BuildLayout()
    {
        ...
        header.Children.Add(new TextBlock
        {
            Text = "Esegue capability registrate e autorizzate tramite Action Engine.",
        ...
        right.Children.Add(new TextBlock
        {
            Text = "L'AI può eseguire solo capability registrate e autorizzate.",
            TextWrapping = TextWrapping.Wrap,
            Foreground = UiTokens.Brush(UiTokens.TextSecondary)
        });
