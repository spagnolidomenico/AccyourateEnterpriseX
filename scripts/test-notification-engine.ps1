Write-Host "Accyourate Enterprise X - Notification Engine smoke test" -ForegroundColor Cyan
...
Write-Host "Build completata. Notification Engine compilabile." -ForegroundColor Green
