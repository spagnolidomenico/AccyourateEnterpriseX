Write-Host "Accyourate Enterprise X - HR Repository smoke test" -ForegroundColor Cyan
...
Write-Host "Build completata. HR Repository compilabile." -ForegroundColor Green
